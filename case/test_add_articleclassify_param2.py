...
print(yaml_path)
a = readyml(yaml_path)
print(a['test_add_articleclassify_param3'])

test_data = a['test_add_articleclassify_param3']
...
def test_add_classify1(login_fixture, delete_data, input_text, expected, title):
    '''用例描述：
